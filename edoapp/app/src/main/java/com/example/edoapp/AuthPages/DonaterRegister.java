...
public class DonaterRegister extends AppCompatActivity {
    ...
    private void register() {//Girilen bilgileri veritabanına gönderdiğimiz kısım
        ...
        mAuth.createUserWithEmailAndPassword(userEmail,userPassword)
                .addOnCompleteListener(DonaterRegister.this, new OnCompleteListener<AuthResult>() {
                    @Override
                    public void onComplete(Task<AuthResult> task) {
                        if(task.isSuccessful()){
                            ...
                            reference= FirebaseDatabase.getInstance().getReference("Donators").child(userid);
                            ...
                            reference.setValue(hashMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    if(task.isSuccessful()){
                                        Intent i = new Intent(DonaterRegister.this, DonaterLogin.class);
